...
#define SRS_EXPORT __attribute__ ((visibility("default")))
...
static double __daylen__( int year, int month, int day,
			  double lon, double lat,
			  double altit, int upper_limb );

static int __sunriset__( int year, int month, int day,
			 double lon, double lat,
			 double altit, int upper_limb,
...
SRS_EXPORT double day_length( int year, int month, int day,
			      double lon, double lat )
{
...
/* the horizon.                                                            */
SRS_EXPORT double day_civil_twilight_length( int year, int month, int day,
					     double lon, double lat )
{
...
/* below the horizon.                                                      */
SRS_EXPORT double day_nautical_twilight_length( int year, int month, int day,
						double lon, double lat )
{
...
/* below the horizon.                                                         */
SRS_EXPORT double day_astronomical_twilight_length( int year, int month, int day,
						    double lon, double lat )
{
...
/* 35 arc minutes below the horizon (this accounts for the refraction    */
/* of the Earth's atmosphere).                                           */
SRS_EXPORT int sun_rise_set( int year, int month, int day,
			     double lon, double lat,
			     double * rise, double * set )
{
...
/* Civil twilight starts/ends when the Sun's center is 6 degrees below     */
/* the horizon.                                                            */
SRS_EXPORT int civil_twilight( int year, int month, int day,
			       double lon, double lat,
...
/* Nautical twilight starts/ends when the Sun's center is 12 degrees       */
/* below the horizon.                                                      */
SRS_EXPORT int nautical_twilight( int year, int month, int day,
				  double lon, double lat,
				  double * start, double * end )
{
...
/* Astronomical twilight starts/ends when the Sun's center is 18 degrees      */
/* below the horizon.                                                         */
SRS_EXPORT int astronomical_twilight( int year, int month, int day,
				      double lon, double lat,
				      double * start, double * end )
{
